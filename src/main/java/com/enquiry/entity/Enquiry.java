...
public class Enquiry {
    ...
    @ElementCollection
    @CollectionTable(name = "enquiry_products", joinColumns = @JoinColumn(name = "enquiry_id"))
    ...
    private String enq_status; // e.g., "NEW", "IN_PROGRESS", "CLOSED", "DELETED"
...
//	}
	...
	public void setEnquiryMode(String enquiryMode) {
