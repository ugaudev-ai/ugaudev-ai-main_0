...
@Entity
@Table(name = "report_at")
public class ReportAuditTrial {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long report_req_no;
	...
	public Long getReport_req_no() {
		return report_req_no;
	}

	public void setReport_req_no(Long report_req_no) {
		this.report_req_no = report_req_no;
	}
